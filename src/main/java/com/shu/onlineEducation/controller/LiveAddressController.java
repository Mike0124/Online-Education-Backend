...
public class LiveAddressController {
	...
	@ResponseBody
	public Result addLiveAddress(String liveAddress, @RequestHeader("Authorization") String jwt) throws ExistedException {
	...
	@ResponseBody
	public Result deleteLiveAddress(Integer liveAddressId, @RequestHeader("Authorization") String jwt) {
	...
	@ResponseBody
	public Result modifyLiveAddress(@RequestBody LiveAddress liveAddress, @RequestHeader("Authorization") String jwt) throws NotFoundException {
