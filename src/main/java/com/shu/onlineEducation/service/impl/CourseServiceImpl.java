...
public class CourseServiceImpl implements CourseService {
    ...
    public List<Course> getAllCoursesByNeedVipAndPreferId(boolean needVip, int preferId) throws
        ...
        if(!courseJpaRepository.existsByNeedVip(needVip)) throw new CourseVipNotFoundException();
        if(!courseJpaRepository.existsByPreferId(preferId)) throw new CoursePreferNotFoundException();
