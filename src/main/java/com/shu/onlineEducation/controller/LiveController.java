...
public class LiveController {
    ...
    public Result findArrangeIsValidInDay(@RequestParam("liveDate")Date liveDate){
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_TEACHER', 'ROLE_ADMIN')")
    public Result addLive(@RequestBody LiveDto liveDto) throws ExistedException {
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_TEACHER', 'ROLE_ADMIN')")
    public Result modifyLive(@RequestParam("liveId") Integer liveId, @RequestBody LiveDto liveDto) throws NotFoundException {
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_TEACHER', 'ROLE_ADMIN')")
    public Result deleteLive(@RequestParam("liveId") Integer liveId){
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_TEACHER', 'ROLE_ADMIN')")
    public Result findAllLiveByTeacher(@RequestParam("teacherId") Integer teacherId){
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_TEACHER', 'ROLE_ADMIN')")
    public Result findAllLiveByDate(@RequestParam("liveDate") Date liveDate){
